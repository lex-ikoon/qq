...
def panes_music() :
    ...
    pane_scene = d.findPaneTab("dual_scene")
...
def note_create() :
    ...
    if track_item_type(track_active) == "music_track_dots" :
        positions = pane_scene_selectpositions(1)[0]
        new_note  = notes_net.createNode("ikn::music_note_dot","ikn_note")
...
def print_file_properties(node) :
    file_path = "/obj/music/scrub/file"
